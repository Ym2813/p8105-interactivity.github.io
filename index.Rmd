...
## Quit and re enter R studio

it will realize thay we r making a website, there will be a "Build" on the left next to "Commit"

## Change theme
in the _site.yml, change theme to for example, cosmo, go to "Build", "Build Website" and then "Save selected"
